 ...
 * *** Please do not edit ! ***
 * @(#) Existe_Camino_1.cs
 * @procedure existeCamino/1 in 189511930.pl
 */
...
public class Existe_Camino_1 : Predicate {
    static internal readonly SymbolTerm f1 = SymbolTerm.MakeSymbol("existeCamino", 1);

    public Term arg1;

    public Existe_Camino_1(Term a1, Predicate cont) {
        arg1 = a1; 
        this.cont = cont;
    }

    public Existe_Camino_1(){}
