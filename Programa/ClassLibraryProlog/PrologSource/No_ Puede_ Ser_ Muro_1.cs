/*
 * *** Please do not edit ! ***
 * @(#) No_Puede_Ser_Muro_1.cs
 * @procedure noPuedeSerMuro/1 in 189511930.pl
 */
...
public class No_Puede_Ser_Muro_1 : Predicate {
    static internal readonly SymbolTerm f1 = SymbolTerm.MakeSymbol("noPuedeSerMuro", 1);

    public Term arg1;

    public No_Puede_Ser_Muro_1(Term a1, Predicate cont) {
        arg1 = a1; 
        this.cont = cont;
    }

    public No_Puede_Ser_Muro_1(){}
