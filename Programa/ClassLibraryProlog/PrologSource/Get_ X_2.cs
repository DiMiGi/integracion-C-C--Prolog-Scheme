 ...
 * *** Please do not edit ! ***
 * @(#) Get_X_2.cs
 * @procedure getX/2 in 189511930.pl
 */
...
public class Get_X_2 : Predicate {
    static internal readonly SymbolTerm s1 = SymbolTerm.MakeSymbol("[]");

    public Term arg1, arg2;

    public Get_X_2(Term a1, Term a2, Predicate cont) {
        arg1 = a1; 
        arg2 = a2; 
        this.cont = cont;
    }
    ...
    public override Predicate exec( Prolog engine ) {
        ...
        if ( a7.IsList() ){
            ...
            if ( !a7.Unify(new ListTerm(a8, engine.makeVariable()), engine.trail) )
                return engine.fail();
        } else {
            return engine.fail();
        }
        ...
        if ( !a8.Unify(a2, engine.trail) ) return engine.fail();
        return cont;
    }
