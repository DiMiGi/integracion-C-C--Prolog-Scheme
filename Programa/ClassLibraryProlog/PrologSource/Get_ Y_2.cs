 ...
 * *** Please do not edit ! ***
 * @(#) Get_Y_2.cs
 * @procedure getY/2 in 189511930.pl
 */
...
public class Get_Y_2 : Predicate {
    static internal readonly SymbolTerm s1 = SymbolTerm.MakeSymbol("[]");

    public Term arg1, arg2;

    public Get_Y_2(Term a1, Term a2, Predicate cont) {
        arg1 = a1; 
        arg2 = a2; 
        this.cont = cont;
    }
    ...
    public override Predicate exec( Prolog engine ) {
        ...
        if ( !a9.Unify(a2, engine.trail) ) return engine.fail();
        return cont;
    }
